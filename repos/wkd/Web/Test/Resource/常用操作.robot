...
选择图片
    ...
    ####选择图片
    ${全部图片}    Get Webelements    //li[@ng-repeat="list in imageLists"]
    ${数量}    Get Length    ${全部图片}
    ${图片}    Evaluate    random.randint(1,${数量})    random
    Sleep    2
    Wait Until Element Is Visible    //*[@id="select_ajax_form"]/div[3]/div/ul/li[${图片}]/a/img    15
    Sleep    1
